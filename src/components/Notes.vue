<template>
    ...
    <div class="grid sm:grid-cols-2 4k:grid-cols-4 max-w-4xl 4k:max-w-screen-2xl gap-8 mx-auto p-8">
        ...
        <div class="bg-beige p-6 rounded-lg shadow-md flex flex-col items-start transform rotate-[-2.18deg]">
            ...
            <h2 class="font-bold text-lg mb-2">One-Stop Shop</h2>
        ...
        <div class="bg-beige p-6 rounded-lg shadow-md flex flex-col items-start transform rotate-[1.55deg]">
            ...
            <h2 class="font-bold text-lg mb-2">Intuitive</h2>
            <p class="text-sm">Features for a variety of tasks. No clunky clicking.</p>
        </div>
        ...
        <div class="bg-beige p-6 rounded-lg shadow-md flex flex-col items-start transform rotate-[2.09deg]">
            ...
            <h2 class="font-bold text-lg mb-2">Analyze Intercoder Reliability</h2>
            <p class="text-sm">Calculate in a variety of ways to what extent annotators agree.</p>
        </div>
        ...
        <div class="bg-beige p-6 rounded-lg shadow-md flex flex-col items-start transform rotate-[-1.95deg]">
            ...
            <h2 class="font-bold text-lg mb-2">Share your Work</h2>
            <p class="text-sm">Make your datasets, labels, and annotated data findable.</p>
        </div>
    </div>
</template>
